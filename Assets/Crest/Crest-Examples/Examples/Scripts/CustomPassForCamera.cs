    ...
    public abstract class CustomPassForCameraBase : MonoBehaviour
    {
        ...
        internal class CustomPassURP : ScriptableRenderPass
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                // Unity 6: RTHandle-basierte Targets benutzen, nicht mehr die obsolete cameraColorTarget / cameraDepthTarget.
                // Wir stellen hier explizit den aktuellen RenderTarget-Zustand wieder her.
        ...
        void EnqueuePass(ScriptableRenderContext context, Camera camera)
        {
            ...
            // Es gibt keinen Bedarf, den CommandBuffer zu leeren – wir nehmen einen aus dem Pool.
