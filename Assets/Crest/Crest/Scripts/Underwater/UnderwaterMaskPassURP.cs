...
namespace Crest
{
    ...
    internal class UnderwaterMaskPassURP : ScriptableRenderPass
    {
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            // Wir umgehen die obsolete ConfigureTarget(RenderTargetIdentifier, ...) API
            // und setzen das RenderTarget direkt über den CommandBuffer.

            // Masken- und Tiefen-Target als aktuelles RenderTarget setzen:
            cmd.SetRenderTarget(_underwaterRenderer._maskTarget, _underwaterRenderer._depthTarget);

            // Maske + Depth auf schwarz / leer initialisieren (wie vorher ConfigureClear):
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (_underwaterRenderer._mode != UnderwaterRenderer.Mode.FullScreen && _underwaterRenderer._volumeGeometry != null)
            {
                _underwaterRenderer.PopulateVolume(
                    commandBuffer,
                    _underwaterRenderer._volumeFrontFaceTarget,
                    _underwaterRenderer._volumeBackFaceTarget
                );

                // Copy only the stencil by copying everything and clearing depth.
                commandBuffer.CopyTexture(
                    _underwaterRenderer._mode == UnderwaterRenderer.Mode.Portal
                        ? _underwaterRenderer._volumeFrontFaceTarget
                        : _underwaterRenderer._volumeBackFaceTarget,
                    _underwaterRenderer._depthTarget
                );
                ...
                Helpers.Blit(
                    ...
                    (int)Helpers.UtilityPass.ClearDepth
                );
            }

            _underwaterRenderer.SetUpMask(
                commandBuffer,
