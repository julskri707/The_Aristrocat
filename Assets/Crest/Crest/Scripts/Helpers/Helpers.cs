...
namespace Crest
{
    ...
    {
        // Unity 6: XRGraphics existiert nicht mehr.
        // Wenn du XR brauchst, müsstest du hier über die neuen XR APIs (z.B. XRSystem) prüfen.
        // Für normale Nicht-XR-Projekte lassen wir isMSAA einfach so.
        // isMSAA bleibt also einfach camera.allowMSAA.
    }
#endif
