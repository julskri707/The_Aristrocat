...
public class ControlPointOverlayManager : MonoBehaviour
{
    ...
    bool TryRebuildHandlesForIndependentHouseEnvelope()
    {
        ...
        // Aucun lot ciblé : ne pas court-circuiter tout l’overlay — sinon pas de poignées blanches sur le contour
        // de l’enveloppe (l’utilisateur ne peut pas déplacer les sommets / milieux tant qu’il n’a pas recliqué le mur).
