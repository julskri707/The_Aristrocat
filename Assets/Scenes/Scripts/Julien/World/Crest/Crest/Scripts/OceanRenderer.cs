...
#pragma warning restore 414
        ...
        bool VerifyRequirements()
        {
            ...
            {
                if (!(GraphicsSettings.defaultRenderPipeline as UniversalRenderPipelineAsset).supportsCameraOpaqueTexture)
                {
                ...
                if (!(GraphicsSettings.defaultRenderPipeline as UniversalRenderPipelineAsset).supportsCameraDepthTexture)
                {
